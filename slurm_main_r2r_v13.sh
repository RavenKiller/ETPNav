...
#SBATCH --output=r2r_v13_eval_aug.out
...
flag1="--exp_name release_r2r_v13
      --run-type train
      ...
      TASK_CONFIG.TASK.NDTW.GT_PATH data/datasets/R2R_VLNCE_v1-2_preprocessed/{split}/{split}_gt.json.gz
      TASK_CONFIG.TASK.SDTW.GT_PATH data/datasets/R2R_VLNCE_v1-2_preprocessed/{split}/{split}_gt.json.gz
...
flag2=" --exp_name release_r2r_v13
      --run-type eval
      --exp-config run_r2r/iter_train.yaml
      SIMULATOR_GPU_IDS [0]
      TORCH_GPU_IDS [0]
...
flag3="--exp_name release_r2r_v13
      --run-type inference
      --exp-config run_r2r/iter_train.yaml
      SIMULATOR_GPU_IDS [0]
      TORCH_GPU_IDS [0]
      ...
      TASK_CONFIG.TASK.SDTW.GT_PATH data/datasets/R2R_VLNCE_v1-3_preprocessed/{split}/{split}_gt.json.gz
      TASK_CONFIG.DATASET.DATA_PATH data/datasets/R2R_VLNCE_v1-3_preprocessed_BERTidx/{split}/{split}_bertidx.json.gz
      INFERENCE.CKPT_PATH data/logs/checkpoints/release_r2r_v13/ckpt.iter12000.pth
